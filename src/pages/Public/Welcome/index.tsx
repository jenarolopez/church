    ...
    <ParallaxProvider>
      ...
      <section className=" flex flex-col tablet:flex-row gap-10 translate-y-[-5rem]  items-center justify-center flex-wrap">
        ...
        <div className="w-[80%] h-80 tablet:max-w-[20rem] shadow-xl bg-white rounded-xl p-10 flex flex-col items-center text-slate-600 text-sm font-pop">
          ...
          />
          <span className="mt-2 flex flex-col items-center">
            <p className="text-center font-bold text-md">NEW TO OUR FAMILY?</p>
      ...
      <section className="flex flex-col items-center font-pop laptop:mb-20 mb-40">
        ...
        <p className="mt-10 px-6 tablet:px-20 desktop:px-60 text-sm text-slate-600 text-center">
          ...
          repellat. Harum nostrum aut, dolores accusamus placeat itaque suscipit
          dolore, fugiat architecto assumenda beatae ad quisquam. Incidunt
          consequatur repudiandae molestias nobis. Lorem ipsum dolor, sit amet
          consectetur adipisicing elit. Itaque libero exercitationem laboriosam
          eligendi necessitatibus. Fugit repellendus eum nisi error placeat, aut
          voluptas ducimus culpa? Nesciunt ipsum quisquam excepturi dolores
          voluptates.
        </p>
      ...
      >
        <div className="flex flex-col-reverse laptop:flex-row laptop:px-48 px-2 laptop:gap-12 pt-20">
          ...
          <div className="relative w-full laptop:w-1/2">
            <img
              src={PhoneLive}
              className="z-[10] laptop:h-[789px] w-[250px] laptop:w-auto absolute left-1/2 transform -translate-x-1/2 -translate-y-[180px] laptop:left-0 laptop:transform-none"
            />
          </div>
        </div>
        <div
      ...
      <section className="flex flex-col items-center font-pop mb-20 mt-20 laptop:mt-64">
        ...
        <h3
          className={
            "text-2xl text-slate-400 tracking-[5px] laptop:tracking-[20px]"
          }
        >
          ANNOUNCEMENTS
        </h3>
